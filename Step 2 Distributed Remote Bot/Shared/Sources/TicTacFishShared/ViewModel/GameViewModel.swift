...
public final class GameViewModel: ObservableObject {
        ...
        do {
            ...
            if let opponent = opponent {
                ...
                Task {
                    ...
                    log("move", "inform opponent about move: \(move)")
                    try await opponent.opponentMoved(move)
                    log("move", "inform opponent about move: \(move) - DONE.")
                    ...
                    log("move", "ask opponent about move...")
                    let opponentMove = try await opponent.makeMove()
                    log("move", "ask opponent about move, DONE: \(opponentMove)")
    ...
    public func foundOpponent(_ opponent: OpponentPlayer, myself: MyPlayer, informOpponent: Bool) {
        ...
        // STEP 3: local multiplayer, enable telling the other player
//        if informOpponent {
//            Task {
